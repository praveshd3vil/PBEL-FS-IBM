...
let finalPrices = Object.entries(product).map(([product, price]) => {
    return {
        product: product,
...
//discount is 15% each on product
//find out final price of each product after discount in certain relevent data structures